...
import_files -norecurse "$src_path/rtl/AES_Comp.v" \
			...
			"$src_path/rtl/general/FSM_FIFO.vhd" \
                        ...
                        "$src_path/rtl/sensor/dspe1.v" \
                        "$src_path/rtl/sensor/DSPSensor.v"
...
add_files -fileset constrs_1 -norecurse "$src_path/xdc/constraints_LeakyDSP.xdc"
import_files -fileset constrs_1 "$src_path/xdc/constraints_LeakyDSP.xdc"
